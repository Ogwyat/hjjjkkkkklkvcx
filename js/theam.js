...
! function() {
    ...
    null !== (e = document.querySelector('[data-bs-toggle="mode"]')) && (t = e.querySelector(".form-check-input"), "dark" === mode ? (root.classList.add("dark-mode"), logos.forEach(function(logo){
        logo.src = document.getElementById("srcLogoLight").value;
      }), t.checked = !0) : (root.classList.remove("dark-mode"), t.checked = !1, logos.forEach(function(logo){
        logo.src = document.getElementById("srcLogoDark").value;
      })), e.addEventListener("click", function(e) {

            t.checked ? (root.classList.add("dark-mode"), window.localStorage.setItem("mode", "dark"), logos.forEach(function(logo){
                logo.src = document.getElementById("srcLogoLight").value;
              })) : (root.classList.remove("dark-mode"), window.localStorage.setItem("mode", "light"), logos.forEach(function(logo){
                logo.src = document.getElementById("srcLogoDark").value;
              }))
